...
*/
  ...
  */
 function shcherbenko_scripts_capabilitiesone() {
     wp_enqueue_style( 'shcherbenko-capabilitiesoneCSS', get_template_directory_uri() . '/css/styles_capabilitiesone.css', false, NULL, 'all');
     if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
     wp_enqueue_script( 'comment-reply' );
   }
 }
 add_action( 'wp_enqueue_scripts', 'shcherbenko_scripts_capabilitiesone' );
...
echo 'single-capabilities.php';
$postID = get_the_ID();
?>

<?php
$query = new WP_Query( array( 'post_type' => 'capabilities', 'page_id' => $postID ) );
...
?>
    <main>
        <div class="wrapper">
            <div class="main-nav">
                  <a href="<?php echo  home_url('/capabilities/'); ?>" class="nk_to-all-projects linkOK" >Все возможности</a>
            </div>
        </div>
