<?php
/**
 * This file registers the Works custom post type
 *
 */
...
function shcherbenko_toolbox_register_works() {

	$slug = apply_filters( 'shcherbenko_clients_rewrite_slug', 'works' );

	$labels = array(
		'name'                  => _x( 'Works', 'Post Type General Name', 'shcherbenko_toolbox' ),
		'singular_name'         => _x( 'Works', 'Post Type Singular Name', 'shcherbenko_toolbox' ),
		'menu_name'             => __( 'Works', 'shcherbenko_toolbox' ),
		'name_admin_bar'        => __( 'Works', 'shcherbenko_toolbox' ),
		'archives'              => __( 'Item Archives', 'shcherbenko_toolbox' ),
		'parent_item_colon'     => __( 'Parent Item:', 'shcherbenko_toolbox' ),
		'all_items'             => __( 'All Works', 'shcherbenko_toolbox' ),
		'add_new_item'          => __( 'Add New Works', 'shcherbenko_toolbox' ),
		'add_new'               => __( 'Add New Works', 'shcherbenko_toolbox' ),
		'new_item'              => __( 'New Works', 'shcherbenko_toolbox' ),
		'edit_item'             => __( 'Edit Works', 'shcherbenko_toolbox' ),
		'update_item'           => __( 'Update Works', 'shcherbenko_toolbox' ),
		'view_item'             => __( 'View Works', 'shcherbenko_toolbox' ),
		'search_items'          => __( 'Search Works', 'shcherbenko_toolbox' ),
...
add_action( 'init', 'shcherbenko_toolbox_register_works', 0 );
